    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-end">
                <div>
                    <h2 className="text-2xl font-black tracking-tighter uppercase text-white italic">Organization Management</h2>
                            ...
                            {loading ? (
                                ...
                                <tr key={t.id} className="hover:bg-white/10 transition-colors group">
                                    <td className="px-6 py-4">
                                        <div className="font-bold text-white group-hover:text-fuchsia-300 transition-colors">{t.name}</div>
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex justify-end gap-2">
                                            <button
                                                ...
                                                className="bg-fuchsia-600 hover:bg-fuchsia-500 text-white px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all shadow-lg shadow-fuchsia-600/20"
                                            >
                                                Impersonate
                                            </button>
                                        </div>
