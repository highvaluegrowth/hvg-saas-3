...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    icon: 'megaphone',
    roles: ['tenant_admin', 'super_admin'],
    description: 'Social media posts and marketing',
  },
  {
    label: 'Feed',
    href: '/feed',
    icon: 'rss',
    roles: ['tenant_admin', 'staff_admin', 'staff', 'resident'],
    description: 'Community news feed',
  },
  {
    label: 'Contracts',
    href: '/contracts',
    icon: 'file',
    roles: ['tenant_admin', 'staff_admin', 'super_admin'],
    description: 'Resident contracts and e-signatures',
  },
  {
    label: 'Blog',
    href: '/blog',
  ...
  },
  {
    ...
    icon: 'mappin',
    roles: ['tenant_admin'],
    description: 'Public tenant directory listing',
  },
  {
    label: 'Contacts',
    href: '/contacts',
...
export const iconPaths: Record<string, string> = {
  ...
  creditcard: 'M2 10h20M7 15h2m4 0h2M4 6h16a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2z',
  ...
  rss: 'M6 5c7.18 0 13 5.82 13 13M6 11a7 7 0 017 7M6 17a1 1 0 110 2 1 1 0 010-2z',
  ...
  addressbook: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z',
